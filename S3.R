...
install.packages("datos") #Este comando descarga paquete
library(datos) #Este comando abre el paquete

#Vamos a explorar la matriz de datos con los siguientes comandos
flores<-(datos::flores)
?flores#Esto es ayuda
dim(flores) #Esto dimension
names(flores) #Me da el nombre de las variables
str(flores) #Me da el tipo de variable
anyNA(flores) #Identificar o me indica los datos perdidos
typeof(flores) #Me dice el tipo de matriz de datos
View(flores) #Me da la visualizacion de la tabla (data frame)
...
#calcularemos la varianza de cada una de las variables
#cuantitativas
...
#Calcularemos el error para la variable del largo del sepalo
...
color=c("darkolivegreen2","darkslategray2","darkseagreen3")

#Construimos el gráfico de la variable x
barplot(tabla_especies,xlab = "Especies", ylab = "Frecuencias", main = "Gráfico de barras de Especies", col =color)
...
#Correlaciones 
#Utilizamos Pearson para datos con distribucion normal
...
#el valor de p es menor que alfa (nivel de significancia[0.05])
